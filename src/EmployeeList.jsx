            ...
            <tr>
                ...
                <td>
                    ...
                    <Modal show={this.state.modalVisible} onHide={this.toggleModal} centered>
                        ...
                        <Modal.Footer>
                            <Button variant="danger" className="mt-4" onClick={this.toggleModal}>Cancel</Button>
                            <Button variant="success" className="mt-4" onClick={this.onDeleteClick}>Yes</Button>
                        </Modal.Footer>
                    </Modal>
                </td>
            </tr>
...
export default class EmployeeList extends React.Component {
    ...
    deleteEmployee(id) {
        ...
        .then(response => {
            ...
            // this above can be done with add employee as well
        })
    }
    render() {
        return (
