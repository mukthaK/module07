...
export default class EmployeeAdd extends React.Component {
    ...
    handleSubmit(e) {
        // e.preventDefault(); // its the button triggering the submission and not te form so we dont need this
        ...
        return (
            <>
                <div className="addEmployee">
                    <Button variant="primary" size="sm" onClick={this.handleShowModal}>New Employee</Button>
                </div>
